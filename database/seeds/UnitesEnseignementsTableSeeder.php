...
class UnitesEnseignementsTableSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		$devmob->td_nb_groupes_affectes = 2;
		$devmob->tp_nb_groupes_attendus = 3;
		$devmob->tp_nb_groupes_affectes = 2;
		$devmob->ei_nb_groupes_attendus = 0;
		$devmob->ei_nb_groupes_affectes = 0;
		...
		$algo->cm_volume_affecte = 0;
		$algo->td_volume_attendu = 30;
		$algo->td_volume_affecte = 30;
		$algo->tp_volume_attendu = 15;
		$algo->tp_volume_affecte = 10;
		$algo->ei_volume_attendu = 15;
		$algo->ei_volume_affecte = 5;
		$algo->td_nb_groupes_attendus = 2;
		$algo->td_nb_groupes_affectes = 2;
		$algo->tp_nb_groupes_attendus = 4;
		$algo->tp_nb_groupes_affectes = 4;
		$algo->ei_nb_groupes_attendus = 2;
		$algo->ei_nb_groupes_affectes = 2;
