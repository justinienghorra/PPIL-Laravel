...
<ul id="dropdown_notifs" class="dropdown-content">
    <li><a class="black-text" href="#!">TODO : Gérer les notifs <i
...
<nav class="light-blue lighten-1" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo"><img class="navbar-logo"
                                                                                               src="/images/SGE.png"
                                                                                               alt=""></a>
        ...
        <ul id="slide-out" class="side-nav">
            ...
            <li><a class="dropdown-button" href="#!" data-activates="dropdown3">Notifications<i
                            class="material-icons right">arrow_drop_down</i><span
                            class="badge badge-notifs orange white-text" data-badge-caption="">2</span></a></li>
            <li>
