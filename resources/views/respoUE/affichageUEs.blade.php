...
<!----------------------------------- 
				...
				TODO
Back-end : modifier heures + sécuriser l'ajout/suppression
            ...
            <div class="row">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="row">
                            <form class="col s12" method="post" action="/respoUE/deleteEnseignant">
                                ...
                                @endforeach
                                <button class="right btn btn-flat red-text" type="submit">Supprimer
                                </button>
                            </form>
                        </div>
                        ...
                        <div class="row">
                            <form class="col s12" method="post" action="/respoUE/addEnseignant">
                                ...
                                <button class="right btn btn-flat green-text" type="submit">Ajouter
                                </button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="modal" id="modal-gerer-horaires-{{$ue->id}}">
                    <div class="modal-content">
                        ...
                        <div class="row">
                            <button class="btn btn-flat green-text right" type="submit">Valider
                            </button>
                        </div>
